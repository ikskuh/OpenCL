...
namespace OpenCL
{
	...
	public struct Context : IDisposable
	{
		...
		{
			int error;
			var context = OpenCLNative.NativeMethods.clCreateContext(IntPtr.Zero, (uint)devices.Length, devices, IntPtr.Zero, IntPtr.Zero, out error);
		...
		{
			int error;
			var context = OpenCLNative.NativeMethods.clCreateContext(properties, (uint)devices.Length, devices, IntPtr.Zero, IntPtr.Zero, out error);
			OpenCLNative.ThrowError(error);
			return context;
		}
		...
		{
			int error;
			CommandQueue queue = OpenCLNative.NativeMethods.clCreateCommandQueue(this, device, properties, out error);
			OpenCLNative.ThrowError(error);
			return queue;
		}
		...
		{
			int error;
			Memory memory = OpenCLNative.NativeMethods.clCreateBuffer(this, flags, (uint)size, IntPtr.Zero, out error);
			OpenCLNative.ThrowError(error);
			return memory;
		}
		...
		public Memory CreateBuffer<T>(MemoryFlags flags, T value) where T : struct
		{
			...
			Memory memory = OpenCLNative.NativeMethods.clCreateBuffer(this, flags, (uint)(size), mem, out error);
		...
		{
			int error;
			Memory memory = OpenCLNative.NativeMethods.clCreateBuffer(this, flags, (uint)size, data, out error);
			OpenCLNative.ThrowError(error);
			return memory;
		}
		...
		{
			int error;
			Memory memory = OpenCLNative.NativeMethods.clCreateBuffer(this, flags, (uint)(values.Length), values, out error);
			OpenCLNative.ThrowError(error);
			return memory;
		}
		...
		{
			int error;
			Memory memory = OpenCLNative.NativeMethods.clCreateBuffer(this, flags, (uint)(sizeof(float) * values.Length), values, out error);
			OpenCLNative.ThrowError(error);
			return memory;
		}
		...
		{
			int error;
			Memory memory = OpenCLNative.NativeMethods.clCreateImage2D(this, flags, ref format, (uint)width, (uint)height, (uint)row_pitch, host_ptr, out error);
			OpenCLNative.ThrowError(error);
			return memory;
		}
		...
		{
			int error;
			Memory memory = OpenCLNative.NativeMethods.clCreateImage3D(this, flags, ref format, (uint)width, (uint)height, (uint)depth, (uint)row_pitch, (uint)slice_pitch, host_ptr, out error);
			OpenCLNative.ThrowError(error);
			return memory;
		}
		...
		{
			int error;
			Memory memory = OpenCLNative.NativeMethods.clCreateFromGLTexture2D(this, flags, texture_target, miplevel, texture, out error);
			OpenCLNative.ThrowError(error);
			return memory;
		}
		...
		public Program CreateProgram(params string[] sources)
		{
			...
			int error;
			Program pgm = OpenCLNative.NativeMethods.clCreateProgramWithSource(this, (uint)sources.Length, strings, lengths, out error);
			OpenCLNative.ThrowError(error);
			return pgm;
		}
		...
		public void Dispose()
		{
			OpenCLNative.ThrowError(OpenCLNative.NativeMethods.clReleaseContext(this));
		}
	}
}
